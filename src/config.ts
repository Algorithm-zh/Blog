...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		homeText: {
			...
			title: "Code World", // Homepage banner main title
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/Algorithm-zh", // Internal links should not include base path as it will be automatically added
	...
	links: [
		{
			...
			url: "https://github.com/Algorithm-zh",
		},
	],
};
